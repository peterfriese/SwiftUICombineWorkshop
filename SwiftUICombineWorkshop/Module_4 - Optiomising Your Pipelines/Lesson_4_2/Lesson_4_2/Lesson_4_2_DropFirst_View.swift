/// Lesson 4.2: Ignore the first event when assigning a pipeline
///
/// Steps:
/// 1. Add the `dropFirst` operator to all pipelines that map user input to network calls
...
struct Lesson_4_2_DropFirst_View: View {
...
struct Lesson_4_2_DropFirst_Previews: PreviewProvider {
    static var previews: some View {
        Lesson_4_2_DropFirst_View()
    }
}
