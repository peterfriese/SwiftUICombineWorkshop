/// Lesson 3.4: Receive events on the main thread
///
/// Steps:
/// 1. Add `receive(on:)` to the pipeline that calls `checkIsUsernameAvailable`
...
struct Lesson_3_4_MainThread_View: View {
