/// Lesson 3.3: Better data mapping
///
/// Steps:
/// 1. Use the `keypath` version of `map` to extract the `data` part of the tuple return type
/// 2. Use `decode` to make use of the Decodable protocol to decode `data` to `UserNameAvailableMessage`
/// 3. Use the `keypath` version of `map` to extract the `isAvailable` attribute from `UserNameAvailableMessage`
...
struct Lesson_3_3_CombineDataMapping_View: View {
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        Lesson_3_3_CombineDataMapping_View()
    }
}
